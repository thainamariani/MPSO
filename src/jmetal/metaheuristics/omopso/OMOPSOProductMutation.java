...
public class OMOPSO extends Algorithm {
  ...
  */ 
  ...
  private Operator productOperator_;
  ...
  */    
  ...
  public void initParams(){
    ...
    productOperator_ = (Mutation)operators_.get("productOperator");
  ...
  private void mopsoMutation(int actualIteration, int totalIterations) throws JMException{       
	...
	productOperator_.setParameter("currentIteration",actualIteration);

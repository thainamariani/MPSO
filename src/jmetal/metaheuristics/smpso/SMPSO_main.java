...
public class SMPSO_main {
    ...
    public static void main(String[] args) throws JMException, IOException, ClassNotFoundException {
        ...
        Reader reader = new Reader("CAS.txt", " ");
        reader.read();
    ...
    /*logger_      = Configuration.logger_ ;
        ...
        double mutationProbability = 0;//1.0/problem.getNumberOfVariables()
        ...
        //mutation = MutationFactory.getMutationOperator("ProductCrossover", parameters);                    
        ...
        problem.writeHypervolume(dir.getPath() + "/A_RESULT", execucoes, swarmSize, maxIterations, mutationProbability, distributionIndex, archiveSize, "SMPSO", hypervolume, estimatedTime, "CAS.txt");

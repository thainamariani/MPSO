...
public abstract class Problem implements Serializable {
    ...
    public void writeHypervolumeSMPSO(String filePath, int execucoes, int swarmSize, int maxIterations, double mutationProbability, double distributionIndex, int archiveSize, String algorithm, double[] hypervolume, long estimatedTime, String inputFile) {
        FileOutputStream fos = null;
        try {
            File file = new File(filePath);
            if (!file.exists()) {
            ...
            bw.write("Distribution Index: " + distributionIndex);
            bw.newLine();
            bw.write("Mutation Probability: " + mutationProbability);
            bw.newLine();
            bw.write("Swarm Size: " + swarmSize);
            bw.newLine();
            bw.write("Max Iterations: " + maxIterations);
            bw.newLine();
            bw.write("Number of Generations: " + (maxIterations / swarmSize));
            bw.newLine();
            bw.write("Archive Size: " + archiveSize);
            bw.newLine();
            bw.write("Best Pareto: Execution " + bestFile);
